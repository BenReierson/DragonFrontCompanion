...
namespace DragonFrontCompanion.Ioc;
...
public class SimpleIoc : ISimpleIoc
{
    ...
    /// <returns>All the already created instances of the given type.</returns>
    public IEnumerable<TService?> GetAllCreatedInstances<TService>() where TService : class
    {
        var serviceType = typeof(TService);
        return GetAllCreatedInstances(serviceType)
           .Select(instance => instance as TService);
    }
    ...
    {
        return DoGetService(typeof(TService), _defaultKey) as TService;
    }
    ...
    /// must be returned.</typeparam>
    /// <returns>An instance of the given type.</returns>
    public TService? GetInstanceWithoutCaching<TService>() where TService : class
    {
        return DoGetService(typeof(TService), _defaultKey, false) as TService;
    }
    ...
    {
        return DoGetService(typeof(TService), key) as TService;
    }
    ...
    /// <param name="key">The key uniquely identifying this instance.</param>
    /// <returns>An instance corresponding to the given type and key.</returns>
    public TService? GetInstanceWithoutCaching<TService>(string key) where TService : class
    {
        return DoGetService(typeof(TService), key, false) as TService;
    }
