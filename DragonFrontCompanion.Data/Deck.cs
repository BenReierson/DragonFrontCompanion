...
using System.ComponentModel;
 ...
 [JsonObject]
 public class Deck : ObservableCollection<Card>, IEquatable<Deck>
 {
     ...
     public bool Equals(Deck deck)
     {
         ...
         if (equal)
         {
             ...
             if (equal && deck.Champion != null) equal = deck.Champion.Equals(Champion);
         }
         
         if (equal) equal = this.SequenceEqual(deck);
     ...
     public override int GetHashCode()
         => HashCode.Combine(AppVersion, ID, (int)DeckFaction);
